package si.seraph.opensource.seraphapi.apiwrappers.hypixel.games.bedwars.utils;
...
public abstract class BedwarsUtils extends HypixelGameBase {
    ...
    public String starColor(int star) {
        String string = "";
        if (star < 100) {
            string = ChatColour.GREY + "[" + star + "\u272B" + "]";
        } else if (star < 200) {
            string = ChatColour.WHITE + "[" + star + "\u272B" + "]";
        } else if (star < 300) {
            string = ChatColour.GOLD + "[" + star + "\u272B" + "]";
        } else if (star < 400) {
            string = ChatColour.AQUA + "[" + star + "\u272B" + "]";
        } else if (star < 500) {
            string = ChatColour.DARK_GREEN + "[" + star + "\u272B" + "]";
        } else if (star < 600) {
            string = ChatColour.DARK_AQUA + "[" + star + "\u272B" + "]";
        } else if (star < 700) {
            string = ChatColour.DARK_RED + "[" + star + "\u272B" + "]";
        } else if (star < 800) {
            string = ChatColour.LIGHT_PURPLE + "[" + star + "\u272B" + "]";
        } else if (star < 900) {
            string = ChatColour.BLUE + "[" + star + "\u272B" + "]";
        } else if (star < 1000) {
            string = ChatColour.DARK_PURPLE + "[" + star + "\u272B" + "]";
        } else {
