...
public class StatListener {
    ...
    public void onChat(ClientChatReceivedEvent chat) {
        ...
        if (msg.contains("QUICK MATHS! Solve: ")) {
            System.out.println("found");
            Handler.asExecutor(() -> {
                String num = msg.replace("QUICK MATHS! Solve: ", "");
                String stringnum = String.valueOf(eval(num));
                sleep(1850);
                Minecraft.getMinecraft().thePlayer.sendChatMessage(stringnum.replace(".0", ""));
            });
        }
        if (umsg.contains("QUICK MATHS! Solve: ")) {
            System.out.println("found");
            Handler.asExecutor(() -> {
                String num = umsg.replace("QUICK MATHS! Solve: ", "");
